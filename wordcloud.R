...
wordcloud(mycorpus,scale=c(3,.6),min.freq=75,max.words=175,random.order=FALSE, colors=brewer.pal(8, "Dark2"),random.color=TRUE, rot.per=.1,use.r.layout=FALSE,fixed.asp=TRUE)
